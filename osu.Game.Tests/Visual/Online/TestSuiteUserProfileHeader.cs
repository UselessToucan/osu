...
{
    public class TestSuiteUserProfileHeader : OsuTestSuite
    {
        ...
        public TestSuiteUserProfileHeader()
        {
            header = new ProfileHeader();
            Add(header);

            AddStep("Show test dummy", () => header.User.Value = TestSuiteUserProfileOverlay.TEST_USER);
